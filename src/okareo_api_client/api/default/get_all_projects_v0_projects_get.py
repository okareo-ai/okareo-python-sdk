...
) -> Optional[Union[HTTPValidationError, List["ProjectResponse"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, List["ProjectResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, List['ProjectResponse']]
    """
