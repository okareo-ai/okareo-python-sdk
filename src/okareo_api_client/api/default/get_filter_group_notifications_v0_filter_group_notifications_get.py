...
) -> ErrorResponse | list[GetFilterGroupNotificationsV0FilterGroupNotificationsGetResponse200Item] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | list[GetFilterGroupNotificationsV0FilterGroupNotificationsGetResponse200Item]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | list[GetFilterGroupNotificationsV0FilterGroupNotificationsGetResponse200Item]
    """
