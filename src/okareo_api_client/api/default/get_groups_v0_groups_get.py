...
) -> ErrorResponse | list[GetGroupsV0GroupsGetResponse200Item] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | list[GetGroupsV0GroupsGetResponse200Item]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | list[GetGroupsV0GroupsGetResponse200Item]
    """
