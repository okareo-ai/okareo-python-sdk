...
) -> ErrorResponse | EvaluatorGenerateResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | EvaluatorGenerateResponse]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | EvaluatorGenerateResponse
    """
