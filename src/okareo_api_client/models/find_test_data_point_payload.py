...
class FindTestDataPointPayload:
    """
    Attributes:
        id (Union[None, UUID, Unset]): ID of the datapoint
        test_run_id (Union[None, UUID, Unset]): ID of the test run
        scenario_data_point_id (Union[None, UUID, Unset]): ID of the scenario data point
        metric_type (Union[None, Unset, str]):
        full_data_point (Union[None, Unset, bool]):  Default: False.
    """
    ...
    full_data_point: Union[None, Unset, bool] = False
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        full_data_point: Union[None, Unset, bool]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_full_data_point(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
