...
T = TypeVar("T", bound="GenerateFromSeedData")


@_attrs_define
class GenerateFromSeedData:
    """
    Attributes:
        ...
        seed_data (Union[Unset, List['SeedData']]): List of seed datas to be used for generation
        generation_type (Union[Unset, ScenarioType]): An enumeration. Default: ScenarioType.TEXT_REVERSE_QUESTION.
    ...
    generation_type: Union[Unset, ScenarioType] = ScenarioType.TEXT_REVERSE_QUESTION
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        generate_from_seed_data.additional_properties = d
        return generate_from_seed_data
