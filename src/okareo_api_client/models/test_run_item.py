...
class TestRunItem:
    ...
    Attributes:
        ...
        num_generated (Union[Unset, int]): Number of data points generated by the model for this test run
        num_evaluated (Union[Unset, int]): Number of generated data points evaluated by Okareo for this test run
        num_expected (Union[Unset, int]): Number of data points expected to be evaluated by Okareo for this test run
    ...
    num_generated: Union[Unset, int] = 0
    num_evaluated: Union[Unset, int] = 0
    num_expected: Union[Unset, int] = 0
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if num_generated is not UNSET:
            field_dict["num_generated"] = num_generated
        if num_evaluated is not UNSET:
            field_dict["num_evaluated"] = num_evaluated
        if num_expected is not UNSET:
            field_dict["num_expected"] = num_expected
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        num_generated = d.pop("num_generated", UNSET)

        num_evaluated = d.pop("num_evaluated", UNSET)

        num_expected = d.pop("num_expected", UNSET)
