...
class DatapointFilterItem:
    ...
    Attributes:
        ...
        description (Union[None, Unset, str]): Optional description for this filter
        checks (Union[None, Unset, list[str]]): Checks to apply to datapoints in the filter.
        project_id (Union[None, UUID, Unset]): Project ID these filters belong to
        filter_group_id (Union[None, UUID, Unset]): Group ID for filter
        latest_test_run (Union['DatapointFilterItemLatestTestRunType0', Any, None, Unset]): Group ID for filter
        datapoint_count (Union[Any, None, Unset, int]): Group ID for filter
        issue_count (Union[Any, None, Unset, int]): Count of issues for this filter
        error_count (Union[Any, None, Unset, int]): Count of errors for this filter
        average_metrics (Union['DatapointFilterItemAverageMetricsType0', Any, None, Unset]): Metrics for checks in this
            filter
        failed_checks (Union[Unset, Any]): Array of failed cheßck names Default: [].
        avg_latency (Union[Any, None, Unset, float]): Average latency for completions
        total_cost (Union[Any, None, Unset, float]): Total dollar cost of all completions
        avg_num_turns (Union[Any, None, Unset, float]): Average number of turns for completions
        slack_enabled (Union[None, Unset, bool]): Whether Slack notifications are enabled for this filter group
        email_enabled (Union[None, Unset, bool]): Whether Email notifications are enabled for this filter group
        time_created (Union[None, Unset, datetime.datetime]): Created datetime for this filter group
        time_updated (Union[None, Unset, datetime.datetime]): Last updated datetime for this filter group
    """
    ...
    latest_test_run: Union["DatapointFilterItemLatestTestRunType0", Any, None, Unset] = UNSET
    datapoint_count: Union[Any, None, Unset, int] = UNSET
    issue_count: Union[Any, None, Unset, int] = UNSET
    error_count: Union[Any, None, Unset, int] = UNSET
    average_metrics: Union["DatapointFilterItemAverageMetricsType0", Any, None, Unset] = UNSET
    failed_checks: Union[Unset, Any] = []
    avg_latency: Union[Any, None, Unset, float] = UNSET
    total_cost: Union[Any, None, Unset, float] = UNSET
    avg_num_turns: Union[Any, None, Unset, float] = UNSET
    ...
    time_updated: Union[None, Unset, datetime.datetime] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        latest_test_run: Union[Any, None, Unset, dict[str, Any]]
        ...
        datapoint_count: Union[Any, None, Unset, int]
        if isinstance(self.datapoint_count, Unset):
            datapoint_count = UNSET
        else:
            datapoint_count = self.datapoint_count

        issue_count: Union[Any, None, Unset, int]
        if isinstance(self.issue_count, Unset):
            issue_count = UNSET
        else:
            issue_count = self.issue_count

        error_count: Union[Any, None, Unset, int]
        if isinstance(self.error_count, Unset):
            error_count = UNSET
        else:
            error_count = self.error_count

        average_metrics: Union[Any, None, Unset, dict[str, Any]]
        ...
        avg_latency: Union[Any, None, Unset, float]
        if isinstance(self.avg_latency, Unset):
            avg_latency = UNSET
        else:
            avg_latency = self.avg_latency

        total_cost: Union[Any, None, Unset, float]
        if isinstance(self.total_cost, Unset):
            total_cost = UNSET
        else:
            total_cost = self.total_cost

        avg_num_turns: Union[Any, None, Unset, float]
        ...
        time_updated: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_latest_test_run(data: object) -> Union["DatapointFilterItemLatestTestRunType0", Any, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["DatapointFilterItemLatestTestRunType0", Any, None, Unset], data)

        latest_test_run = _parse_latest_test_run(d.pop("latest_test_run", UNSET))

        def _parse_datapoint_count(data: object) -> Union[Any, None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            return cast(Union[Any, None, Unset, int], data)

        datapoint_count = _parse_datapoint_count(d.pop("datapoint_count", UNSET))

        def _parse_issue_count(data: object) -> Union[Any, None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_error_count(data: object) -> Union[Any, None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_average_metrics(data: object) -> Union["DatapointFilterItemAverageMetricsType0", Any, None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union["DatapointFilterItemAverageMetricsType0", Any, None, Unset], data)

        average_metrics = _parse_average_metrics(d.pop("average_metrics", UNSET))

        failed_checks = d.pop("failed_checks", UNSET)

        def _parse_avg_latency(data: object) -> Union[Any, None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            return cast(Union[Any, None, Unset, float], data)

        avg_latency = _parse_avg_latency(d.pop("avg_latency", UNSET))

        def _parse_total_cost(data: object) -> Union[Any, None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_avg_num_turns(data: object) -> Union[Any, None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_time_updated(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
