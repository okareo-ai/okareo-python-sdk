...
T = TypeVar("T", bound="TargetPerformanceCheckSummary")


@_attrs_define
class TargetPerformanceCheckSummary:
    """
    Attributes:
        check_id (UUID):
        check_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        target_performance_check_summary = cls(
            check_id=check_id,
            check_name=check_name,
            run_count=run_count,
            datapoint_count=datapoint_count,
        ...
        target_performance_check_summary.additional_properties = d
        return target_performance_check_summary
