...
from okareo_api_client.models import ScenarioSetResponse, ScenarioType, TestRunType, SeedData, ScenarioSetCreate, ScenarioSetGenerate
...
def create_scenario_set(okareo_client: Okareo) -> ScenarioSetResponse:
    ...
    articles: ScenarioSetResponse = okareo_client.create_scenario_set(scenario_set_create)
...
def generate_scenarios(
    ...
    scenario_set_generate = ScenarioSetGenerate(source_scenario_id=create_scenario_set.scenario_id,
...
def test_get_scenario_data_points(get_scenario_data_points: List[ScenarioDataPoinResponse]) -> None:
    assert get_scenario_data_points is not None
    assert len(get_scenario_data_points) is not 0
