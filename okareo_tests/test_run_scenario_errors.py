...
from okareo_api_client.models import ScenarioSetResponse, ScenarioType
...
class TestScenarioExceptions:
    ...
    def test_seed_data_missing(self, okareo_client: Okareo) -> None:
        ...
        with pytest.raises(Exception, match="Non-empty seed data is required to create a scenario set"):
    ...
    def test_duplicate_name(self, okareo_client: Okareo) -> None:
        ...
        assert response.warning is not None and isinstance(response.warning, str) and "is already in use" in response.warning
    ...
    def test_seed_data_processing_error(self, okareo_client: Okareo) -> None:
        ...
        complex_input["data"]["nested"]["more_nested"]["circular"] = complex_input  # Create circular reference
    ...
    def test_file_validation_error_missing_fields(self, okareo_client: Okareo) -> None:
        ...
        with tempfile.NamedTemporaryFile(suffix=".jsonl", mode="w") as missing_fields_file:
            missing_fields_file.write('{"only_input": "test"}\n')  # Missing result field
            missing_fields_file.write('{"only_result": "test"}\n')  # Missing input field
