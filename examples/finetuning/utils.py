...
def get_model_tokenizer_trainer(model_id, finetuned_model_name, dataset, epochs=3, target_modules=[]):
    ...
    max_seq_length = max(n_train_tokens) # max sequence length for model and packing of the dataset
    ...
    # if "phi" in finetuned_model_name:
        # trainer_kwargs['train_dataset'] = dataset['train']
